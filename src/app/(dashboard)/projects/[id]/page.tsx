...
import { Database, Settings2, Code2, ExternalLink, Loader2 } from 'lucide-react'
        ...
        <div className="mt-6 rounded-xl border border-gray-200 bg-white p-5">
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <dd className="mt-0.5 font-mono text-xs text-gray-700 bg-gray-50 rounded px-2 py-1 mt-1">
                {project.id}
              </dd>
            </div>
            <div>
